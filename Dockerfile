...
RUN cd /home/webrtc/webrtc.googlecode.com && \
    ...
    GYP_DEFINES="enable_tracing=1 build_with_libjingle=1 build_with_chromium=0 component=shared_library remove_webcore_debug_symbols=1 fastbuild=1" \
...
RUN cd /home/webrtc/webrtc.googlecode.com/src && \
    GYP_DEFINES="enable_tracing=1 build_with_libjingle=1  component=shared_library remove_webcore_debug_symbols=1 fastbuild=1" \
